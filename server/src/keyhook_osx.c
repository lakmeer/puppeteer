...
FILE *logFile = NULL;
int counter = 0;
bool enableLogfileMode = 0;

// Forward
char* keyCodeToReadableString (CGKeyCode);
CGEventRef logfileEventCallback  (CGEventTapProxy, CGEventType, CGEventRef, void *);
CGEventRef printoutEventCallback (CGEventTapProxy, CGEventType, CGEventRef, void *);
